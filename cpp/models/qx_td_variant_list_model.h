#ifndef QX_TD_VARIANT_LIST_MODEL_H
#define QX_TD_VARIANT_LIST_MODEL_H
...
class QxTdVariantListModel : public QAbstractListModel
{
    Q_OBJECT
    Q_PROPERTY(int count READ count NOTIFY countChanged)
public:
    explicit QxTdVariantListModel(QObject *parent = 0);
...
#endif // QX_TD_VARIANT_LIST_MODEL_H
