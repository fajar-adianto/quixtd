...
#include "qx_td_object_list_model.h"
...
/*!
    \fn static QQmlObjectListModel * QQmlObjectListModel::create (QObject * parent = nullptr)
...
/*!
    ...
    \return The typed pointer to the object, or \c nullptr if the type doesn't match
