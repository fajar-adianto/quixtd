...
class QxTdObjectListModelBase : public QAbstractListModel
{ // abstract Qt base class
    Q_OBJECT
    Q_PROPERTY(int count READ count NOTIFY countChanged)

public:
    explicit QxTdObjectListModelBase(QObject *parent = nullptr)
...
class QxTdObjectListModel : public QxTdObjectListModelBase
{
public:
    explicit QxTdObjectListModel(QObject *parent = nullptr,
                                 const QByteArray &displayRole = QByteArray(),
                                 const QByteArray &uidRole = QByteArray())
        : QxTdObjectListModelBase(parent)
        , m_count(0)
...
public: // C++ API
    ...
    {
        return (!m_indexByUid.isEmpty() ? m_indexByUid.value(uid, nullptr) : nullptr);
    }
