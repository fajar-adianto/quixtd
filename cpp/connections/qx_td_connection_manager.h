...
class QxTdConnectionManager : public QObject
{
    Q_OBJECT
    ...
    QML_SINGLETON
public:
    static QxTdConnectionManager *create(QQmlEngine *qml_engine, QJSEngine *js_engine)
    {
        Q_UNUSED(qml_engine);
        Q_UNUSED(js_engine);
        QxTdConnectionManager *result = new QxTdConnectionManager();

        return result;
    }

    explicit QxTdConnectionManager(QObject *parent = nullptr);
...
private slots:
    void handleConnectionStateChanged(QxTdConnectionState *state);
