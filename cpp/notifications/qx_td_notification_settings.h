#ifndef QX_TD_NOTIFICATION_SETTINGS_H
#define QX_TD_NOTIFICATION_SETTINGS_H

#include "common/qx_td_object.h"

class QxTdNotificationSettings : public QxTdObject
{
    Q_OBJECT
    ...
    QML_ELEMENT
    QML_UNCREATABLE("QxTdNotificationSettings and its derived classes cannot be created in QML.")
public:
    explicit QxTdNotificationSettings(QObject *parent = nullptr);
...
private:
    Q_DISABLE_COPY(QxTdNotificationSettings)
...
#endif // QX_TD_NOTIFICATION_SETTINGS_H
